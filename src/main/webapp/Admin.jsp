...
<form action = "admin" method="post">
    <div class="cont">
        ...
        <br><br><br><br>
            ...
            <br>
            <br>
            <input id="button" class="submit" type="submit" value=" Log In" > 
         
        </div>

        <div class="sub-cont">
            <div class="img">
                <div class="img__text m--up"><br><br>
           		<h3>" There is no friend as loyal as a Book. "<h3><br><br><br><br>
           		<h3>" The more that you read , the more things you will know. 
           				The more that you learn , the more places you will go. "<h3><br><br><br><br>
           		<h3>" A reader lives a thousand lives before he dies. "<h3><br>
           		</div>
 </form>
    <script>
